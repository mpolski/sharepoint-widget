...
import * as strings from 'AiAgentWebPartStrings';
import AiAgent from './components/AiAgent';
import { IAiAgentProps } from './components/IAiAgentProps';
...
export default class AiAgentWebPart extends BaseClientSideWebPart<IAiAgentWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IAiAgentProps> = React.createElement(
      AiAgent,
      {
